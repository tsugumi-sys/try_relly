...
impl<B: ByteSliceMut> Slotted<B> {
    ...
    // insert data (body in Slotted struct) and move pointer and calculate remaining space.
    //
    // num_slots: The number of records (slots).
    // free_space_offset: The current boundary where free space begins.
